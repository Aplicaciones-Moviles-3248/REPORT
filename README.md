...
<br>
                ...
                <br>
                AV2:<br>
  Durante el desarrollo del AV2, actualizó y aplicó conocimientos relacionados con el desarrollo de aplicaciones móviles nativas para el proyecto Courtly. Implementó la aplicación dirigida a entrenadores utilizando Kotlin, Jetpack Compose y Android Studio, desarrollando funcionalidades como el registro e inicio de sesión, persistencia del token de autenticación, validación del rol del entrenador y navegación hacia el panel profesional. Asimismo, trabajó en los bounded contexts de IAM, Coaches y Availabilities, implementando la creación, consulta y actualización del perfil profesional, así como la gestión de horarios disponibles. También realizó la integración con el backend mediante Retrofit, participó en la resolución de errores de conexión y autenticación, y apoyó en la integración del código mediante GitHub. Estas actividades le permitieron fortalecer sus conocimientos en arquitectura móvil, consumo de servicios REST, persistencia de sesión e integración entre aplicaciones.<br>
             </td>
            <td style="border: 1px solid #ddd; vertical-align: top;">
                AV1<br>
        ...
        <tr>
            ...
            <td style="border: 1px solid #ddd; vertical-align: top;">
                ...
                AV2: Durante el AV2, reconocí la importancia del aprendizaje constante en el desarrollo frontend móvil con Flutter, que permita a los usuarios acceder de manera satisfactoria a las funciones de la aplicación, aplicando y reforzando mis conocimientos de desarrollo de software y de pruebas apropiadas que validen la disponibilidad y eficiencia de las funciones implementadas.<br><br>
                <strong>Camilla Espinoza</strong><br>
                AV1:<br>
...
<br>
                ...
                AV2:<br>
Durante el desarrollo del AV2, reconoció la importancia del aprendizaje permanente al investigar y aplicar nuevas tecnologías para el desarrollo móvil nativo, como Kotlin, Jetpack Compose, Retrofit y el almacenamiento local de sesiones. Para cumplir con las funcionalidades asignadas, reforzó sus conocimientos sobre autenticación mediante tokens, consumo de servicios REST, manejo de respuestas del backend, organización del código mediante bounded contexts y sincronización de información entre la aplicación de entrenadores y la aplicación Flutter de jugadores. Además, fortaleció sus habilidades en control de versiones y trabajo colaborativo mediante el uso de ramas, revisión de cambios y procesos de integración en GitHub. Este proceso le permitió comprender que el desarrollo de soluciones móviles requiere una actualización constante para resolver problemas técnicos, integrar distintos sistemas y mantener una aplicación funcional y escalable.<br>
            </td>
            <td style="border: 1px solid #ddd; vertical-align: top;">
                AV1<br>
